...
public class CourseModel
{
    ...
    public virtual ICollection<StudentModel> Students { get; set; } = new HashSet<StudentModel>(); // Many-to-Many relationship
    public virtual ICollection<TeacherModel> Teachers { get; set; } = new HashSet<TeacherModel>(); // Many-to-Many relationship
}